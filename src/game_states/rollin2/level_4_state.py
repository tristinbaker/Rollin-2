"""
Level 4 State for Rollin 2
Autumn-themed level — harder than Level 3, introduces a brutal thin-path gauntlet.
"""
import pygame
import os
...
class Level4State(LevelState):
    ...
    def update(self):
        if self.handle_death_screen(self.gsm.ROLLIN2_LEVEL4_STATE):
            return
