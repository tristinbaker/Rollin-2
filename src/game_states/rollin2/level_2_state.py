...
class Level2State(LevelState):
    ...
    def init(self):
        """Initialize Rollin 2 Level 2"""
        print("Initializing Rollin 2 Level 2...")
        ...
        if "rollin2_level2" not in audio.music_clips:
            audio.load_music("rollin2_level2", "Level_2.wav")  # Using Rollin 2 music
        ...
        print("Rollin 2 Level 2 initialized!")

    def update(self):
        """Update level logic"""
        # Handle death screen
        if self.handle_death_screen(self.gsm.ROLLIN2_LEVEL2_STATE):
            return
